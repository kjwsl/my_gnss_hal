...
namespace hardware {
namespace gnss {
class BnGnssBatchingCallback : public ::android::BnInterface<IGnssBatchingCallback> {
public:
  static constexpr uint32_t TRANSACTION_gnssLocationBatchCb = ::android::IBinder::FIRST_CALL_TRANSACTION + 0;
  static constexpr uint32_t TRANSACTION_getInterfaceVersion = ::android::IBinder::FIRST_CALL_TRANSACTION + 16777214;
  static constexpr uint32_t TRANSACTION_getInterfaceHash = ::android::IBinder::FIRST_CALL_TRANSACTION + 16777213;
  explicit BnGnssBatchingCallback();
  ::android::status_t onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) override;
  int32_t getInterfaceVersion();
  std::string getInterfaceHash();
};  // class BnGnssBatchingCallback

class IGnssBatchingCallbackDelegator : public BnGnssBatchingCallback {
public:
  explicit IGnssBatchingCallbackDelegator(const ::android::sp<IGnssBatchingCallback> &impl) : _aidl_delegate(impl) {}

  ::android::sp<IGnssBatchingCallback> getImpl() { return _aidl_delegate; }
  ::android::binder::Status gnssLocationBatchCb(const ::std::vector<::android::hardware::gnss::GnssLocation>& locations) override {
    return _aidl_delegate->gnssLocationBatchCb(locations);
  }
  int32_t getInterfaceVersion() override {
    int32_t _delegator_ver = BnGnssBatchingCallback::getInterfaceVersion();
...
private:
  ::android::sp<IGnssBatchingCallback> _aidl_delegate;
