...
namespace hardware {
namespace gnss {
class BpGnssBatchingCallback : public ::android::BpInterface<IGnssBatchingCallback> {
public:
  explicit BpGnssBatchingCallback(const ::android::sp<::android::IBinder>& _aidl_impl);
  virtual ~BpGnssBatchingCallback() = default;
