...
namespace hardware {
namespace gnss {
class BpGnssAntennaInfo : public ::android::BpInterface<IGnssAntennaInfo> {
public:
  explicit BpGnssAntennaInfo(const ::android::sp<::android::IBinder>& _aidl_impl);
  virtual ~BpGnssAntennaInfo() = default;
