...
class IGnssAntennaInfo : public ::android::IInterface {
public:
  typedef IGnssAntennaInfoDelegator DefaultDelegator;
  DECLARE_META_INTERFACE(GnssAntennaInfo)
  static inline const int32_t VERSION = 3;
  static inline const std::string HASH = "747fa8b8b4bb55d21f2c42446dd1b31de1dfbeaa";
  virtual ::android::binder::Status setCallback(const ::android::sp<::android::hardware::gnss::IGnssAntennaInfoCallback>& callback) = 0;
