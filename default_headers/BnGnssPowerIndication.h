...
public:
  explicit IGnssPowerIndicationDelegator(const ::android::sp<IGnssPowerIndication> &impl) : _aidl_delegate(impl) {}

  ::android::sp<IGnssPowerIndication> getImpl() { return _aidl_delegate; }
  ::android::binder::Status setCallback(const ::android::sp<::android::hardware::gnss::IGnssPowerIndicationCallback>& callback) override {
    ::android::sp<::android::hardware::gnss::IGnssPowerIndicationCallbackDelegator> _callback;
    if (callback) {
      _callback = ::android::sp<::android::hardware::gnss::IGnssPowerIndicationCallbackDelegator>::cast(delegate(callback));
    }
    return _aidl_delegate->setCallback(_callback);
  }
  ::android::binder::Status requestGnssPowerStats() override {
    return _aidl_delegate->requestGnssPowerStats();
  }
  int32_t getInterfaceVersion() override {
    int32_t _delegator_ver = BnGnssPowerIndication::getInterfaceVersion();
...
private:
  ::android::sp<IGnssPowerIndication> _aidl_delegate;
