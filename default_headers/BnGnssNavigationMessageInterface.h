...
namespace hardware {
namespace gnss {
class BnGnssNavigationMessageInterface : public ::android::BnInterface<IGnssNavigationMessageInterface> {
public:
  ...
  explicit BnGnssNavigationMessageInterface();
  ::android::status_t onTransact(uint32_t _aidl_code, const ::android::Parcel& _aidl_data, ::android::Parcel* _aidl_reply, uint32_t _aidl_flags) override;
  int32_t getInterfaceVersion();
  std::string getInterfaceHash();
};  // class BnGnssNavigationMessageInterface

class IGnssNavigationMessageInterfaceDelegator : public BnGnssNavigationMessageInterface {
public:
  explicit IGnssNavigationMessageInterfaceDelegator(const ::android::sp<IGnssNavigationMessageInterface> &impl) : _aidl_delegate(impl) {}

  ::android::sp<IGnssNavigationMessageInterface> getImpl() { return _aidl_delegate; }
  ::android::binder::Status setCallback(const ::android::sp<::android::hardware::gnss::IGnssNavigationMessageCallback>& callback) override {
    ::android::sp<::android::hardware::gnss::IGnssNavigationMessageCallbackDelegator> _callback;
    if (callback) {
      _callback = ::android::sp<::android::hardware::gnss::IGnssNavigationMessageCallbackDelegator>::cast(delegate(callback));
    }
  ...
  int32_t getInterfaceVersion() override {
    int32_t _delegator_ver = BnGnssNavigationMessageInterface::getInterfaceVersion();
...
private:
  ::android::sp<IGnssNavigationMessageInterface> _aidl_delegate;
