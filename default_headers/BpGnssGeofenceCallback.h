...
namespace hardware {
namespace gnss {
class BpGnssGeofenceCallback : public ::android::BpInterface<IGnssGeofenceCallback> {
public:
  explicit BpGnssGeofenceCallback(const ::android::sp<::android::IBinder>& _aidl_impl);
  virtual ~BpGnssGeofenceCallback() = default;
