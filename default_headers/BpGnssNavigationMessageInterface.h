...
namespace hardware {
namespace gnss {
class BpGnssNavigationMessageInterface : public ::android::BpInterface<IGnssNavigationMessageInterface> {
public:
  explicit BpGnssNavigationMessageInterface(const ::android::sp<::android::IBinder>& _aidl_impl);
  virtual ~BpGnssNavigationMessageInterface() = default;
...
};  // class BpGnssNavigationMessageInterface
}  // namespace gnss
}  // namespace hardware
}  // namespace android
