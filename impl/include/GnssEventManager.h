#ifndef __GNSS_EVENT_MANAGER_H__
#define __GNSS_EVENT_MANAGER_H__
...
namespace gnss::impl {
    ...
    class GnssEventManager {
        ...
        public:
            GnssEventManager() = default;
            virtual ~GnssEventManager() = default;
...
#endif// __GNSS_EVENT_MANAGER_H__
